...
def run_named_query(path, as_json=True, params={}):
    """
    ...
    try:
        ...
        raise General.Errors.ExceptionWithDetails("Error getting named query at path: %s, with params: %s" % (path, params), LOGGER, e)

def run_scalar_named_query_json(path, params={}):
    """
